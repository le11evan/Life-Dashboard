  ...
  return (
    <div className="rounded-2xl p-4 bg-gradient-to-br from-blue-500/10 to-cyan-500/5 border border-blue-500/20 hover:border-blue-500/30 transition-colors">
      <div className="flex items-center justify-between mb-3">
        ...
        <Link
          href="/tasks"
          className="text-xs text-[#8888a0] hover:text-blue-400 flex items-center transition-colors"
        >
          View all
      ...
      <div>
        {pendingTasks.length === 0 ? (
          <div className="py-4 text-center">
            <p className="text-sm text-[#8888a0]">No pending tasks</p>
            <Link
              href="/tasks?add=true"
        ...
        <div className="flex items-center justify-between pt-3 mt-3 border-t border-white/[0.06] text-sm">
          <span className="text-[#8888a0]/60">Total pending</span>
          <span className="font-medium text-blue-400">{tasks.filter((t) => t.status === "pending").length}</span>
        </div>
        <div className="flex items-center justify-between pt-1 text-sm">
          <span className="text-[#8888a0]/60">Completed</span>
  ...
  return (
    <div className="rounded-2xl p-4 bg-gradient-to-br from-green-500/10 to-emerald-500/5 border border-green-500/20 hover:border-green-500/30 transition-colors">
      <div className="flex items-center justify-between mb-3">
        ...
        <Link
          href="/groceries"
          className="text-xs text-[#8888a0] hover:text-green-400 flex items-center transition-colors"
        >
          View all
          <ChevronRight className="w-3 h-3" />
        </Link>
      ...
      <div>
        {uncheckedItems.length === 0 ? (
          <div className="py-4 text-center">
            <p className="text-sm text-[#8888a0]">Shopping list is empty</p>
            <Link
          ...
          <ul className="space-y-2">
            {uncheckedItems.map((item) => (
              <li key={item.id} className="flex items-center gap-2 text-sm text-white/80">
        ...
        <div className="flex items-center justify-between pt-3 mt-3 border-t border-white/[0.06] text-sm">
          <span className="text-[#8888a0]/60">Items to get</span>
  ...
  return (
    <div className="rounded-2xl p-4 bg-gradient-to-br from-amber-500/10 to-orange-500/5 border border-amber-500/20 hover:border-amber-500/30 transition-colors">
      <div className="flex items-center justify-between mb-3">
        ...
        <Link
          href="/journal"
          className="text-xs text-[#8888a0] hover:text-amber-400 flex items-center transition-colors"
        >
          View all
          <ChevronRight className="w-3 h-3" />
        </Link>
      ...
      <div>
        ...
        <div className="flex items-center justify-between pt-3 mt-3 border-t border-white/[0.06] text-sm">
          <span className="text-[#8888a0]/60">Last 30 days</span>
  ...
  return (
    <div className="rounded-2xl p-4 bg-gradient-to-br from-red-500/10 to-rose-500/5 border border-red-500/20 hover:border-red-500/30 transition-colors">
      <div className="flex items-center justify-between mb-3">
        ...
        <Link
          href="/fitness"
          className="text-xs text-[#8888a0] hover:text-red-400 flex items-center transition-colors"
        >
          View all
          <ChevronRight className="w-3 h-3" />
        </Link>
      ...
      <div>
        {stats.templateCount === 0 ? (
          <div className="py-4 text-center">
            <p className="text-sm text-[#8888a0]">No workouts created</p>
            <Link
          ...
          <div>
            <div className="grid grid-cols-2 gap-3 py-2">
              <div className="text-center p-2 rounded-lg bg-white/5">
                ...
                <p className="text-xs text-[#8888a0]/60">workouts</p>
              </div>
              <div className="text-center p-2 rounded-lg bg-white/5">
                <p className="text-lg font-bold text-red-400">{stats.exerciseCount}</p>
                <p className="text-xs text-[#8888a0]/60">exercises</p>
              </div>
            </div>
          </div>
        )}
        <div className="flex items-center justify-between pt-3 mt-1 border-t border-white/[0.06] text-sm">
          <span className="flex items-center gap-1 text-[#8888a0]/60">
  ...
  return (
    <div className="rounded-2xl p-4 bg-gradient-to-br from-lime-500/10 to-green-500/5 border border-lime-500/20 hover:border-lime-500/30 transition-colors">
      <div className="flex items-center justify-between mb-3">
        ...
        <Link
          href="/diet"
          className="text-xs text-[#8888a0] hover:text-lime-400 flex items-center transition-colors"
        >
          View all
          <ChevronRight className="w-3 h-3" />
        </Link>
      ...
      <div>
        <div className="grid grid-cols-2 gap-3 py-2">
          <div className="text-center p-2 rounded-lg bg-white/5">
            ...
            <p className="text-xs text-[#8888a0]/60">cal goal</p>
          </div>
          <div className="text-center p-2 rounded-lg bg-white/5">
            <p className="text-lg font-bold text-lime-400">{stats.goals.protein}g</p>
            <p className="text-xs text-[#8888a0]/60">protein</p>
          </div>
        </div>
        <div className="flex items-center justify-between pt-3 mt-1 border-t border-white/[0.06] text-sm">
          <span className="flex items-center gap-1 text-[#8888a0]/60">
  ...
  return (
    <div className="rounded-2xl p-4 bg-gradient-to-br from-emerald-500/10 to-teal-500/5 border border-emerald-500/20 hover:border-emerald-500/30 transition-colors">
      <div className="flex items-center justify-between mb-3">
        ...
        <Link
          href="/finance"
          className="text-xs text-[#8888a0] hover:text-emerald-400 flex items-center transition-colors"
        >
          View all
          <ChevronRight className="w-3 h-3" />
        </Link>
      ...
      <div>
        {stats.holdingsCount === 0 ? (
          <div className="py-4 text-center">
            <p className="text-sm text-[#8888a0]">No positions yet</p>
            <Link
              href="/finance"
        ...
        <div className="flex items-center justify-between pt-3 mt-3 border-t border-white/[0.06] text-sm">
          <span className="text-[#8888a0]/60">Positions</span>
  ...
  return (
    <div className="rounded-2xl p-4 bg-gradient-to-br from-violet-500/10 to-purple-500/5 border border-violet-500/20 hover:border-violet-500/30 transition-colors">
      <div className="flex items-center justify-between mb-3">
        ...
        <Link
          href="/goals"
          className="text-xs text-[#8888a0] hover:text-violet-400 flex items-center transition-colors"
        >
          View all
          <ChevronRight className="w-3 h-3" />
        </Link>
      ...
      <div>
        {stats.active === 0 ? (
          <div className="py-4 text-center">
            <p className="text-sm text-[#8888a0]">No active goals</p>
            <Link
              href="/goals"
          ...
          <div className="space-y-2">
            {activeGoals.map((goal) => (
              <div key={goal.id} className="flex items-center gap-2">
                ...
                <span className="text-sm truncate flex-1 text-white/80">{goal.title}</span>
                <span className="text-xs text-[#8888a0]/60">{goal.progress}%</span>
              </div>
            ))}
          </div>
        )}
        <div className="flex items-center justify-between pt-3 mt-3 border-t border-white/[0.06] text-sm">
          <span className="text-[#8888a0]/60">Active</span>
  ...
  return (
    <div className="rounded-2xl p-4 bg-gradient-to-br from-cyan-500/10 to-blue-500/5 border border-cyan-500/20 hover:border-cyan-500/30 transition-colors">
      <div className="flex items-center justify-between mb-3">
        ...
        <Link
          href="/learn"
          className="text-xs text-[#8888a0] hover:text-cyan-400 flex items-center transition-colors"
        >
          View all
          <ChevronRight className="w-3 h-3" />
        </Link>
      ...
      <div>
        {topArticles.length === 0 ? (
          <div className="py-4 text-center">
            <p className="text-sm text-[#8888a0]">No news available</p>
          </div>
        ) : (
          <div className="space-y-3">
            {topArticles.map((article, i) => (
              <div key={i} className="border-b border-white/[0.06] pb-2 last:border-0">
                <span className="text-xs text-cyan-400">{article.category}</span>
                <p className="text-sm text-white/80 line-clamp-1">{article.title}</p>
              </div>
            ))}
          </div>
        )}
        <div className="flex items-center justify-between pt-3 mt-1 border-t border-white/[0.06] text-sm">
          <span className="text-[#8888a0]/60">Articles today</span>
  ...
  return (
    <div className="rounded-2xl p-4 bg-gradient-to-br from-yellow-500/10 to-orange-500/5 border border-yellow-500/20 hover:border-yellow-500/30 transition-colors">
      <div className="flex items-center justify-between mb-3">
        ...
        <Link
          href="/creative"
          className="text-xs text-[#8888a0] hover:text-yellow-400 flex items-center transition-colors"
        >
          View all
          <ChevronRight className="w-3 h-3" />
        </Link>
      ...
      <div>
        <div className="py-4 text-center">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-sm text-[#8888a0]">ideas captured</span>
          </div>
          <Link
            href="/creative"
        ...
        <div className="flex items-center justify-between pt-3 mt-3 border-t border-white/[0.06] text-sm">
          <span className="text-[#8888a0]/60">Pinned</span>
...
function WidgetSkeleton() {
  return (
    <div className="rounded-2xl p-4 bg-white/[0.03] border border-white/[0.06]">
      <div className="h-5 w-24 bg-white/[0.05] rounded animate-pulse mb-3" />
      <div className="space-y-2">
